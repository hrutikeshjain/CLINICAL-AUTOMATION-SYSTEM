...
namespace NewProjectCAS.Controllers
{
 ...
 on dd.SupplierId equals s.SupplierId
                ...
                var delivered = (from dd in db.DrugDeliveries
                                 join pod in db.PatientOrderDetails
    on dd.OrderId equals pod.OrderId
                                 join s in db.Suppliers
on dd.SupplierId equals s.SupplierId
