...
namespace NewProjectCAS
{
    ...
    public partial class Project1Entities : DbContext
    {
        ...
        public virtual int UpdateDrugDeatails(Nullable<int> drugId, string drugName, Nullable<System.DateTime> manufactureDate, Nullable<System.DateTime> expiredDate, string usedFor, string sideEffects, Nullable<int> totalQuantityAvailable, Nullable<bool> isDeleted)
        {
            var drugIdParameter = drugId.HasValue ?
                new ObjectParameter("DrugId", drugId) :
                new ObjectParameter("DrugId", typeof(int));
